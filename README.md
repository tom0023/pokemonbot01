# **PokemonBot**
スクールカリキュラムの個人開発フェーズで作成。<br>
可能な範囲で製品並みの実用性を求めました。<br>


## 概要
LINEBOTを利用したポケモンデータ検索<br>
ひらがな/カタカナ入力で対象ポケモンの下記データが返信されます！<br>
オンライン対戦では数値１の差で勝敗が決まることが多々あるので、<br>
最低限必要な下記３項目の取得速度において、このアプリの有用性は現状最高峰と思われます。<br>
※第8世代未対応。随時対応予定<br>
・タイプ<br>
・個体値<br>
・特性<br><br>
...
データベースの差し替えで様々なケースに対応できる可能性を秘めております。<br>
